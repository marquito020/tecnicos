...
<body>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <a class="logo-expand" href="{{ url('home') }}">SRL Servicios</a>
            @can('admin')
            <div class="side-wrapper">
                <div class="side-title">TRABAJADORES</div>
                <div class="side-menu">
                    @can('tecnico.users.index')
                    <a class="sidebar-link discover @yield('tecnico', '')" href="{{url('tecnicos')}}">
                    ...
                    <a class="sidebar-link trending @yield('cliente', '')" href="{{url('clientes')}}">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a class="sidebar-link @yield('administativo', '')" href="{{url('administrativos')}}">
                        <svg viewBox="0 0 24 24" fill="currentColor">
            ...
            @can('tecnico')
            <div class="side-wrapper">
                <div class="side-title">VISTAS</div>
                <div class="side-menu">
                    @can('tecnico')
                    <a class="sidebar-link @yield('trabajos_tecnico', '')" href="{{url('trabajos_tecnico')}}">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M17.769 8.382H22C22 4.985 19.964 3 16.516 3H7.484C4.036 3 2 4.985 2 8.338v7.324C2 19.015 4.036 21 7.484 21h9.032C19.964 21 22 19.015 22 15.662v-.313h-4.231c-1.964 0-3.556-1.552-3.556-3.466 0-1.915 1.592-3.467 3.556-3.467v-.034zm0 1.49h3.484c.413 0 .747.326.747.728v2.531a.746.746 0 01-.747.728H17.85c-.994.013-1.864-.65-2.089-1.595a1.982 1.982 0 01.433-1.652 2.091 2.091 0 011.576-.74zm.151 2.661h.329a.755.755 0 00.764-.745.755.755 0 00-.764-.746h-.329a.766.766 0 00-.54.213.727.727 0 00-.224.524c0 .413.34.75.764.754zM6.738 8.382h5.644a.755.755 0 00.765-.746.755.755 0 00-.765-.745H6.738a.755.755 0 00-.765.737c0 .413.341.75.765.754z" />
                        </svg>
                        Trabajos Asignados
            ...
            <div class="side-wrapper">
                <div class="side-menu">
                    ...
                    <a class="sidebar-link @yield('asistencia', '')" href="{{url('asistencias')}}">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                    ...
                    @endcan
                    @can('admin')
                    <a class="sidebar-link @yield('control_trabajos', '')" href="{{url('control_trabajos')}}">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M17.769 8.382H22C22 4.985 19.964 3 16.516 3H7.484C4.036 3 2 4.985 2 8.338v7.324C2 19.015 4.036 21 7.484 21h9.032C19.964 21 22 19.015 22 15.662v-.313h-4.231c-1.964 0-3.556-1.552-3.556-3.466 0-1.915 1.592-3.467 3.556-3.467v-.034zm0 1.49h3.484c.413 0 .747.326.747.728v2.531a.746.746 0 01-.747.728H17.85c-.994.013-1.864-.65-2.089-1.595a1.982 1.982 0 01.433-1.652 2.091 2.091 0 011.576-.74zm.151 2.661h.329a.755.755 0 00.764-.745.755.755 0 00-.764-.746h-.329a.766.766 0 00-.54.213.727.727 0 00-.224.524c0 .413.34.75.764.754zM6.738 8.382h5.644a.755.755 0 00.765-.746.755.755 0 00-.765-.745H6.738a.755.755 0 00-.765.737c0 .413.341.75.765.754z" />
                        </svg>
                        Control Trabajo
                    ...
                    @endcan
                    @can('admin')
                    <a class="sidebar-link @yield('trabajo_asignados', '')" href="{{url('trabajo_asignados')}}">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M17.769 8.382H22C22 4.985 19.964 3 16.516 3H7.484C4.036 3 2 4.985 2 8.338v7.324C2 19.015 4.036 21 7.484 21h9.032C19.964 21 22 19.015 22 15.662v-.313h-4.231c-1.964 0-3.556-1.552-3.556-3.466 0-1.915 1.592-3.467 3.556-3.467v-.034zm0 1.49h3.484c.413 0 .747.326.747.728v2.531a.746.746 0 01-.747.728H17.85c-.994.013-1.864-.65-2.089-1.595a1.982 1.982 0 01.433-1.652 2.091 2.091 0 011.576-.74zm.151 2.661h.329a.755.755 0 00.764-.745.755.755 0 00-.764-.746h-.329a.766.766 0 00-.54.213.727.727 0 00-.224.524c0 .413.34.75.764.754zM6.738 8.382h5.644a.755.755 0 00.765-.746.755.755 0 00-.765-.745H6.738a.755.755 0 00-.765.737c0 .413.341.75.765.754z" />
                        </svg>
                        Trabajos Asignados
            ...
            <div class="side-wrapper">
                <div class="side-menu">
                    <div class="side-title">ACCIONES</div>

                    @can('servicio.index')
                    <a class="sidebar-link @yield('servicio', '')" href="{{url('servicios')}}">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M17.769 8.382H22C22 4.985 19.964 3 16.516 3H7.484C4.036 3 2 4.985 2 8.338v7.324C2 19.015 4.036 21 7.484 21h9.032C19.964 21 22 19.015 22 15.662v-.313h-4.231c-1.964 0-3.556-1.552-3.556-3.466 0-1.915 1.592-3.467 3.556-3.467v-.034zm0 1.49h3.484c.413 0 .747.326.747.728v2.531a.746.746 0 01-.747.728H17.85c-.994.013-1.864-.65-2.089-1.595a1.982 1.982 0 01.433-1.652 2.091 2.091 0 011.576-.74zm.151 2.661h.329a.755.755 0 00.764-.745.755.755 0 00-.764-.746h-.329a.766.766 0 00-.54.213.727.727 0 00-.224.524c0 .413.34.75.764.754zM6.738 8.382h5.644a.755.755 0 00.765-.746.755.755 0 00-.765-.745H6.738a.755.755 0 00-.765.737c0 .413.341.75.765.754z" />
                        </svg>
                        Servicios
                    ...
                    @endcan
                    @can('trabajo.create')
                    <a class="sidebar-link @yield('asignar_trabajos', '')" href="{{url('asignar_trabajos')}}">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M17.769 8.382H22C22 4.985 19.964 3 16.516 3H7.484C4.036 3 2 4.985 2 8.338v7.324C2 19.015 4.036 21 7.484 21h9.032C19.964 21 22 19.015 22 15.662v-.313h-4.231c-1.964 0-3.556-1.552-3.556-3.466 0-1.915 1.592-3.467 3.556-3.467v-.034zm0 1.49h3.484c.413 0 .747.326.747.728v2.531a.746.746 0 01-.747.728H17.85c-.994.013-1.864-.65-2.089-1.595a1.982 1.982 0 01.433-1.652 2.091 2.091 0 011.576-.74zm.151 2.661h.329a.755.755 0 00.764-.745.755.755 0 00-.764-.746h-.329a.766.766 0 00-.54.213.727.727 0 00-.224.524c0 .413.34.75.764.754zM6.738 8.382h5.644a.755.755 0 00.765-.746.755.755 0 00-.765-.745H6.738a.755.755 0 00-.765.737c0 .413.341.75.765.754z" />
                        </svg>
                        Asignar Trabajo
                    ...
                    @endcan
                    @can('marcado.index')
                    <a class="sidebar-link @yield('marcado', '')" href="{{url('marcado')}}">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M17.769 8.382H22C22 4.985 19.964 3 16.516 3H7.484C4.036 3 2 4.985 2 8.338v7.324C2 19.015 4.036 21 7.484 21h9.032C19.964 21 22 19.015 22 15.662v-.313h-4.231c-1.964 0-3.556-1.552-3.556-3.466 0-1.915 1.592-3.467 3.556-3.467v-.034zm0 1.49h3.484c.413 0 .747.326.747.728v2.531a.746.746 0 01-.747.728H17.85c-.994.013-1.864-.65-2.089-1.595a1.982 1.982 0 01.433-1.652 2.091 2.091 0 011.576-.74zm.151 2.661h.329a.755.755 0 00.764-.745.755.755 0 00-.764-.746h-.329a.766.766 0 00-.54.213.727.727 0 00-.224.524c0 .413.34.75.764.754zM6.738 8.382h5.644a.755.755 0 00.765-.746.755.755 0 00-.765-.745H6.738a.755.755 0 00-.765.737c0 .413.341.75.765.754z" />
                        </svg>
                        Marcar Asistencia
                    ...
                    @endcan
                    @can('control.create')
                    <a class="sidebar-link @yield('marcar_control_trabajos', '')" href="{{url('marcar_control_trabajos')}}">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M17.769 8.382H22C22 4.985 19.964 3 16.516 3H7.484C4.036 3 2 4.985 2 8.338v7.324C2 19.015 4.036 21 7.484 21h9.032C19.964 21 22 19.015 22 15.662v-.313h-4.231c-1.964 0-3.556-1.552-3.556-3.466 0-1.915 1.592-3.467 3.556-3.467v-.034zm0 1.49h3.484c.413 0 .747.326.747.728v2.531a.746.746 0 01-.747.728H17.85c-.994.013-1.864-.65-2.089-1.595a1.982 1.982 0 01.433-1.652 2.091 2.091 0 011.576-.74zm.151 2.661h.329a.755.755 0 00.764-.745.755.755 0 00-.764-.746h-.329a.766.766 0 00-.54.213.727.727 0 00-.224.524c0 .413.34.75.764.754zM6.738 8.382h5.644a.755.755 0 00.765-.746.755.755 0 00-.765-.745H6.738a.755.755 0 00-.765.737c0 .413.341.75.765.754z" />
                        </svg>
                    ...
                    <a class="sidebar-link @yield('formulario', '')" href="{{url('formularioClientes')}}">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                    ...
                    @endcan
                    @can('cliente')
                    <a class="sidebar-link @yield('cliente_crea_formularios', '')" href="{{url('cliente_crea_formularios')}}">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M17.769 8.382H22C22 4.985 19.964 3 16.516 3H7.484C4.036 3 2 4.985 2 8.338v7.324C2 19.015 4.036 21 7.484 21h9.032C19.964 21 22 19.015 22 15.662v-.313h-4.231c-1.964 0-3.556-1.552-3.556-3.466 0-1.915 1.592-3.467 3.556-3.467v-.034zm0 1.49h3.484c.413 0 .747.326.747.728v2.531a.746.746 0 01-.747.728H17.85c-.994.013-1.864-.65-2.089-1.595a1.982 1.982 0 01.433-1.652 2.091 2.091 0 011.576-.74zm.151 2.661h.329a.755.755 0 00.764-.745.755.755 0 00-.764-.746h-.329a.766.766 0 00-.54.213.727.727 0 00-.224.524c0 .413.34.75.764.754zM6.738 8.382h5.644a.755.755 0 00.765-.746.755.755 0 00-.765-.745H6.738a.755.755 0 00-.765.737c0 .413.341.75.765.754z" />
                        </svg>
                        Formulario
            ...
            <div class="side-wrapper">
                <div class="side-title">PERFIL</div>
                <div class="side-menu">
                    <a class="sidebar-link @yield('datos_personales', '')" href="{{url('datos_personales')}}">
                        <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="wrapper">
            <div class="header">
                ...
                <div class="user-settings">
                    <div class="user-name">
                        @can('super_admin')
                        Super Admin: {{Auth::user()->persona->nombre}} {{Auth::user()->persona->apellido_paterno}}
                        @endcan
                        @can('admin')
                        Admin: {{Auth::user()->persona->nombre}} {{Auth::user()->persona->apellido_paterno}}
                        @endcan
                        @can('tecnico')
                        Tecnico : {{Auth::user()->persona->nombre}} {{Auth::user()->persona->apellido_paterno}}
                        @endcan
                        @can('cliente')
                        Cliente : {{Auth::user()->persona->nombre}} {{Auth::user()->persona->apellido_paterno}}
                        @endcan
                    </div>
    ...
    <script src="{{asset('js/inicio.css')}}"></script>
