        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="row mb-3">
                ...
                <div style="text-align: center;">
                    <div class="col-md-6"">
                                    <input class=" form-check-input" type="radio" id="flexRadioDefault1" value="M" name="sexo">
                        <label class="form-check-label" for="flexRadioDefault1">
                            Masculino
                        </label>
                    </div>
                    <div class="col-md-6"">
                                    <input class=" form-check-input" type="radio" id="flexRadioDefault2" value="F" name="sexo">
