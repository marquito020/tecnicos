...
<div class="main-header anim" style="--delay: 0s">Nuestros Servicios</div>
                <div class="main-blogs">
                    <div class="main-blog anim" style="--delay: .1s">
                        <div class="main-blog__title">Pide tu intalcion electrica con nosotros</div>
                    ...
                    <div class="main-blog anim" style="--delay: .2s">
                        <div class="main-blog__title">Pide tu Skateboard con entrega a domicilio</div>
